...
int rxVal1 = 0;
int get_center_mass_high(void){

    return rxVal;
}

int get_center_mass_low(void){

    return rxVal1;
}

int get_difference(){
    int result = rxVal - rxVal1;
    return result;
}
APP_DATA appData;
...
//            if (gotRx || _CP0_GET_COUNT() - startTime > (48000000 / 2 / 150)) {
