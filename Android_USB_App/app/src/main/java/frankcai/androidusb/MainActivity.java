...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                // when the button is pushed, a string is made out of the slider position, and written to the PIC
    ...
    /* These functions initialize the USB host code, add permission to use USB
       detect when the PIC is plugged in
       and append the received data to the data that is already in the green textview.*/
